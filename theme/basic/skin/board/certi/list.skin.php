...
<div id="bo_gall" style="width:<?php echo $width; ?>">
 ...
 <?/*   <div class="bo_sch_wrap">   
    ...
    <ul id="gall_ul" class="gall_row company5">
        <?php for ($i=0; $i<count($list); $i++) {
         ...
         ?>
        <li class="<?php echo implode(' ', $classes); ?> <?php echo $list[$i]['wr_2']; ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                    <div class="gall_img" <?/*style="<?php if ($board['bo_gallery_height'] > 0) echo 'height:'.$board['bo_gallery_height'].'px;max-height:'.$board['bo_gallery_height'].'px'; ?>"*/?>>
                        ...
                        <?php } else {
                            ...
                            if($thumb['src']) {
                                ...
                                $img_content = '<span class="no_image">no_image</span>';
                            }
                    ...
                    <div class="gall_text_href">
                        ...
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                         ...
                         <div class="bo_cnt_wr"><span class="bo_cnt"><?/*<?php echo $list[$i]['wr_2']; ?><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 68, '..'); ?>*/?> </span></div>
                    </div>
