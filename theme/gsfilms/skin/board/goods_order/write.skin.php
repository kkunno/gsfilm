...
<section id="bo_w">
    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="autosave_wrapper write_div">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="form-control full_input required" maxlength="255" placeholder="제목">
    ...
    <div class="text-right m-3">
        <a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn btn-default border btn-sm">취소</a>
