...
.vid_thum {width: 100%; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);}
</style>
...
-->
					...
					<div class="gallery_wrap">
						...
						<li>
							<div class="img js-video-button" data-video-id="<?php echo $list[$i]['wr_1'] ?>" style="background-image: url(https://img.youtube.com/vi/<?php echo $list[$i]['wr_1'] ?>/0.jpg);">
							...
							<!-- /체크박스 -->
							<a class="poplink" poplink="#pop-<?php echo $list[$i]['href'] ?>"></a>
							</div>
