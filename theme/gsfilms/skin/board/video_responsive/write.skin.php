...
-->
						...
						<div class="write_div">
							<label for="wr_1" class="sound_only">유튜브 영상번호<strong>필수</strong></label>
							<input type="text" name="wr_1" value="<?php echo $wr_1; ?>" id="wr_1" required class="frm_input full_input required" size="50" maxlength="255" placeholder="유튜브 영상 ID">
						</div>
...
-->
						...
						<div class="btn_confirm write_div">
							<a href="/bbs/board.php?bo_table=<?php echo $bo_table ?>#tab_menu" class="btn_cancel btn">취소</a>
