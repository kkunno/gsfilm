...
include_once(G5_THEME_PATH.'/head_sub6.php');
...
<!-- 로그인 시작 { -->
	...
	<div class="login-wrap">
		...
		<fieldset id="login_fs">
			...
			<div class="id-box"><input type="text" name="mb_id" id="login_id" required class="frm_input login" size="20" maxLength="20" placeholder="아이디를 입력하세요"></div>
			<label for="login_pw" class="sound_only">비밀번호<strong class="sound_only"> 필수</strong></label>
			<div class="pw-box"><input type="password" name="mb_password" id="login_pw" required class="frm_input password" size="20" maxLength="20" placeholder="비밀번호를 입력하세요"></div>

			<label class="check"><input type="checkbox" name="auto_login" id="login_auto_login">로그인 정보저장</label>
			<button type="submit" class="btn_submit">로그인</button>
			<ul>
				<li><a href="<?php echo G5_BBS_URL ?>/password_lost.php" target="_blank" id="login_password_lost">ID/PW 찾기</a></li>
				<li><a href="<?php echo G5_BBS_URL ?>/register.php" class="join">회원가입</a></li>
			</ul>
...
<?php
include_once(G5_THEME_PATH.'/tail_sub.php');
