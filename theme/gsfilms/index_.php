...
?>
	...
	<div class="main-visual">
        <div class="main-text">
            <img src="<?php echo G5_THEME_URL ?>/images/img_mainvisual_text.png" alt="ECO FRIENDLY FILM">
            <p>생분해 멀칭필름 / 농업용 멀칭필름 / 산업용 수축필름 / 바이오매스 필름 / 자원순환 <b>(주)금성필름</b></p>
        </div>
        <!--<ul class="main-list">
            ...
            <li><a href="/n/bbs/board.php?bo_table=order"><img src="<?php echo G5_THEME_URL ?>/images/icon_main_05.png" alt="">Order</a></li>
        </ul>-->
    ...
    <div class="main-content">
        <div class="main-product up-on-scroll">
            <h2>Product<p class="comment1">최고의 제품을 합리적인 가격으로 제공해드립니다.</p></h2>
            <ul>
                <li>
                ...
                <li>
                    <a href="/n/bbs/content.php?co_id=technicalfilm">
                        ...
                        <p>Every day Fresh를 슬로건으로 하는 <br>㈜금성필름의 공업용 필름 브랜드</p>
            ...
            <div class="main-board">
                ...
                <div class="main-video">
                    ...
                    <ul>
                        ...
                        <li class="js-video-button" data-video-id='0R_hJO2vyWc'><img src="<?php echo G5_THEME_URL ?>/images/icon_main_17.png"></li>
                    </ul>
                </div>
            </div>
